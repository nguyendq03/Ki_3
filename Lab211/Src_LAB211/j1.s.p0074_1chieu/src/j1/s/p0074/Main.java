...
public class Main {
    ...
    /**
     * This is the main method of the program. It contains a while loop that continuously prompts the user for a choice.
     * The user can choose between performing addition, subtraction, multiplication of matrices, or exiting the program.
     * The checkIntLimit method is used to ensure that the user enters a valid choice within the given range.
     * Depending on the user's choice, the corresponding method for matrix addition, subtraction, or multiplication is called.
     * If the user chooses to exit the program, the loop is terminated and the program ends.
     *
    ...
    /**
     * This method generates the menu for the calculator program.
     * Displays the available options for the user to choose from, such as addition, subtraction, multiplication,
     * and quitting the program.It prompts the user to enter their choice.
     */
    ...
    /**
     * This method generates the menu for the calculator program.
     * Displays the available options for the user to choose from, such as addition, subtraction, multiplication, and quitting the program.
    ...
    /**
     * This method is a public static method that checks the user input and ensures that it is an integer.
     *
    ...
    /**
     * This method is used to display a matrix. It takes a 2D array as input and prints each element of the matrix in a formatted manner.
     * The method iterates over each row and column of the matrix and prints the corresponding element enclosed in square brackets.
     * After printing all elements of a row, a new line is printed to separate rows.
     * This method is useful for visualizing the contents of a matrix in a readable format.
     *
